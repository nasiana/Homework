...
"""
Correct :) Really good you included an else statement that would account for invalid responses!
...
"""
This is neatly done, however, the question specifies a restricted range of years: 1800-1950 which you should
have accounted for in the answer. 
...
"""
This is correct, but you had to point out what the mistake was as well.
​
Mark: 3
"""
...
def user_choc_match():
    ...
    return chocolates.get(user_choc,
                          "Please choose from: white, milk, dark and vegan. I do not sell other types of chocolate.")
...
"""
Great solution, especially the statement you provide when there is an invalid input.

Small detail, from a user's perspective, it would have been better to list the types
of chocs you are selling in the input() question as well ;)
​
Mark: 6
"""
...
"""
This is a really good solution, great job on setting lottery_empty() to be a set() (which doesn't allow 
for duplicate numbers, well done!), but it is not clear why you later convert the numbers container 
to a tuple, and then again convert to a list? Just curious :)
​
Mark: 10
"""
...
"""
This is correct, but you had to point out what the problem was as well.
​
Mark: 3
"""
...
"""
Your solution is mostly correct, but you outputted all the information associated with 'moves',
without formatting, into a text file, so you end up with very long lines of info:
{"bulbasaur": [{"move": {"name": "razor-wind", "url": "https://pokeapi.co/api/v2/move/13/"}, "version_group_details": [{"level_learned_at": 0, "move_learn_method":

Not all the information was required (only the name of the pokemon and the moves), and
this isn't quite readable. Try to work on that for future assignments/exercises,
e.g. "The name of the pokemon is...." and then list the moves.
